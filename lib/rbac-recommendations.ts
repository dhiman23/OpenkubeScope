// RBAC Fix Suggestions Engine for KubeScope
// Maps RBAC findings and raw rules to actionable remediation guidance.
// Used by CSV/PDF report generators and the findings UI.
...
// Returns a short recommendation string aligned with the risk level.
